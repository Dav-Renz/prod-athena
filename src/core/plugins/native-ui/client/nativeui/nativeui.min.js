...
import c, {
    requestScaleformMovie as O,
    hasScaleformMovieLoaded as R,
    beginScaleformMovieMethod as u,
    scaleformMovieMethodAddParamBool as d,
    scaleformMovieMethodAddParamPlayerNameString as L,
    scaleformMovieMethodAddParamFloat as U,
    scaleformMovieMethodAddParamInt as C,
    endScaleformMovieMethod as D,
    endScaleformMovieMethodReturnValue as m,
    drawScaleformMovieFullscreen as p,
    setScaleformMovieAsNoLongerNeeded as S,
} from 'natives';
var f;
!(function (e) {
    (e[(e.None = 0)] = 'None'),
        ...
        (e[(e.Star = 18)] = 'Star'),
        (e[(e.Tattoo = 19)] = 'Tattoo'),
        (e[(e.Trevor = 20)] = 'Trevor'),
        (e[(e.Lock = 21)] = 'Lock'),
        (e[(e.Tick = 22)] = 'Tick'),
        (e[(e.Sale = 23)] = 'Sale'),
        (e[(e.ArrowLeft = 24)] = 'ArrowLeft'),
        (e[(e.ArrowRight = 25)] = 'ArrowRight'),
        (e[(e.Audio1 = 26)] = 'Audio1'),
        (e[(e.Audio2 = 27)] = 'Audio2'),
        (e[(e.Audio3 = 28)] = 'Audio3'),
        (e[(e.AudioInactive = 29)] = 'AudioInactive'),
        (e[(e.AudioMute = 30)] = 'AudioMute');
})(f || (f = {}));
var T,
    I = f;
!(function (e) {
...
(V.Empty = new V(0, 0, 0, 0)),
    (V.Transparent = new V(0, 0, 0, 0)),
    (V.Black = new V(0, 0, 0, 255)),
    (V.White = new V(255, 255, 255, 255)),
    (V.WhiteSmoke = new V(245, 245, 245, 255));
class y {
    constructor(e = 0, t = 0) {
...
class F {
    ...
    static Parse(e) {
        if ('object' == typeof e) {
            if (e.length) return new F(e[0], e[1]);
            if (e.X && e.Y) return new F(e.X, e.Y);
        } else if ('string' == typeof e && -1 !== e.indexOf(',')) {
            const t = e.split(',');
            return new F(parseFloat(t[0]), parseFloat(t[1]));
        }
        return new F(0, 0);
    }
}
...
class Y extends b {
    constructor(e, t, i, s, n, h) {
        super(),
            ...
            (this.Pos = t),
            (this.Scale = i),
            (this.Color = s || new V(255, 255, 255, 255)),
            (this.Font = n || 0),
            (this.Centered = h || !1);
    }
    Draw(e, t, i, s, n, h) {
        !e ||
            ...
            n ||
            h ||
            ((t = new F(this.Pos.X + e.Width, this.Pos.Y + e.Height)),
            (i = this.Scale),
            (s = this.Color),
            (n = this.Font),
            (h = this.Centered));
        const o = t.X / 1280,
            r = t.Y / 720;
        c.setTextFont(parseInt(n)),
            c.setTextScale(i, i),
            c.setTextColour(s.R, s.G, s.B, s.A),
            c.setTextCentre(h),
            c.beginTextCommandDisplayText('STRING'),
            Y.AddLongString(e),
            c.endTextCommandDisplayText(o, r, 0);
    }
    static AddLongString(e) {
        if (!e.length) return;
        for (let t, i = 0; i < e.length; i += 99) {
            let s = e.substr(i, i + 99),
                n = i;
            (s.match(/~/g) || []).length % 2 != 0
                ? ((t = s.lastIndexOf('~')), (i -= 99 - t))
                : (t = Math.min(99, e.length - n)),
                c.addTextComponentSubstringPlayerName(e.substr(n, t));
        }
    }
}
const W = c.getActiveScreenResolution(0, 0);
class k {
    static get ResolutionMaintainRatio() {
        const e = k.Width / k.Height;
        return new y(1080 * e, 1080);
    }
    static MousePosition(t = !1) {
        const i = k.ResolutionMaintainRatio,
            s = e();
        let [n, h] = [s.x, s.y];
        return t && ([n, h] = [s.x / i.Width, s.y / i.Height]), { X: n, Y: h };
    }
    static IsMouseInBounds(e, t) {
        const i = k.MousePosition();
        return i.X >= e.X && i.X <= e.X + t.Width && i.Y > e.Y && i.Y < e.Y + t.Height;
    }
    static GetTextWidth(e, t, i) {
        c.beginTextCommandGetWidth('CELL_EMAIL_BCON'), Y.AddLongString(e), c.setTextFont(t), c.setTextScale(1, i);
        const s = c.endTextCommandGetWidth(!0);
        return k.ResolutionMaintainRatio.Width * s;
    }
    static GetLineCount(e, t, i, s, n) {
        c.beginTextCommandLineCount('CELL_EMAIL_BCON'), Y.AddLongString(e);
        const h = k.ResolutionMaintainRatio,
            o = t.X / h.Width,
            r = t.Y / h.Height;
        if ((c.setTextFont(i), c.setTextScale(1, s), n > 0)) {
            const e = t.X / h.Width + n / h.Width;
            c.setTextWrap(o, e);
        }
        return c.endTextCommandLineCount(o, r);
    }
}
(k.Width = W[1]), (k.Height = W[2]);
class v {
    constructor(e, t, i, s, n = 0, h = new V(255, 255, 255)) {
        (this.TextureDict = e),
            (this.TextureName = t),
            (this.Pos = i),
            (this.Size = s),
    ...
    requestTextureDictPromise(e) {
        return new Promise((s, n) => {
            c.requestStreamedTextureDict(e, !0);
            let h = t(() => {
                if (c.hasStreamedTextureDictLoaded(e)) return i(h), s(!0);
            }, 10);
        });
    }
    set TextureDict(e) {
    ...
    get IsTextureDictionaryLoaded() {
        return c.hasStreamedTextureDictLoaded(this._textureDict);
    }
    Draw(e, t, i, s, n, h, o) {
        (e = e || this.TextureDict),
            ...
            (n = n || this.Heading),
            (h = h || this.Color),
            (o = o || !0) && (c.hasStreamedTextureDictLoaded(e) || c.requestStreamedTextureDict(e, !0));
        const r = 1080 * (k.Width / k.Height),
            a = this.Size.Width / r,
            l = this.Size.Height / 1080,
            _ = this.Pos.X / r + 0.5 * a,
            O = this.Pos.Y / 1080 + 0.5 * l;
        c.drawSprite(e, t, _, O, a, l, n, h.R, h.G, h.B, h.A, !0);
    }
}
class B extends b {
    constructor(e, t, i) {
    ...
    Draw(e, t, i) {
        e || (e = new y(0, 0)),
            t || i || ((e = new F(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (t = this.Size), (i = this.Color));
        const s = t.Width / 1280,
            n = t.Height / 720,
            h = e.X / 1280 + 0.5 * s,
            o = e.Y / 720 + 0.5 * n;
        c.drawRect(h, o, s, n, i.R, i.G, i.B, i.A, !1);
    }
}
class G extends B {
    constructor(e, t, i) {
    ...
    Draw(e, t, i) {
        e || (e = new y()),
            !e ||
                t ||
                i ||
                ((e = new F(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (t = this.Size), (i = this.Color));
        const s = 1080 * (k.Width / k.Height),
            n = t.Width / s,
            h = t.Height / 1080,
            o = e.X / s + 0.5 * n,
            r = e.Y / 1080 + 0.5 * h;
        c.drawRect(o, r, n, h, i.R, i.G, i.B, i.A, !1);
    }
}
class K extends Y {
    constructor(e, t, i, s, n, h) {
        super(e, t, i, s || new V(255, 255, 255), n || 0, !1),
            (this.TextAlignment = P.Left),
            (this.Wrap = 0),
            h && (this.TextAlignment = h);
    }
    get WordWrap() {
        return new y(this.Wrap, 0);
    }
    set WordWrap(e) {
        this.Wrap = e.Width;
    }
    Draw(e, t, i, n, h, o, r, a, l) {
        let _ = e,
            O = o,
            R = o;
        e || (e = new y(0, 0)),
            e &&
                ...
                1 == O || 0 == O
                    ? (O = this.Centered)
                    : ((O = void 0), (r = this.DropShadow), (a = this.Outline), this.WordWrap));
        const u = 1080 * (k.Width / k.Height),
            d = this.Pos.X / u,
            L = this.Pos.Y / 1080;
        if ((c.setTextFont(parseInt(h)), c.setTextScale(1, i), c.setTextColour(n.R, n.G, n.B, n.A), void 0 !== O))
            c.setTextCentre(O);
        else {
            switch ((r && c.setTextDropshadow(2, 0, 0, 0, 0), a && s('[NativeUI] ResText outline not working!'), R)) {
                case P.Centered:
                    c.setTextCentre(!0);
                    break;
                case P.Right:
                    c.setTextRightJustify(!0), c.setTextWrap(0, d);
            }
            if (this.Wrap) {
                const e = (this.Pos.X + this.Wrap) / u;
                c.setTextWrap(d, e);
            }
        }
        c.beginTextCommandDisplayText('CELL_EMAIL_BCON'), Y.AddLongString(_), c.endTextCommandDisplayText(d, L, 0);
    }
}
function X() {
    let e,
...
class z {
    constructor(e, t = '', i = null) {
        (this.Id = X()),
            (this.BackColor = z.DefaultBackColor),
            (this.HighlightedBackColor = z.DefaultHighlightedBackColor),
            (this.ForeColor = z.DefaultForeColor),
            (this.HighlightedForeColor = z.DefaultHighlightedForeColor),
            (this.RightLabel = ''),
            (this.LeftBadge = I.None),
            (this.RightBadge = I.None),
            (this.Enabled = !0),
            (this.Data = i),
            (this._rectangle = new G(new F(0, 0), new y(431, 38), new V(150, 0, 0, 0))),
            (this._text = new K(e, new F(8, 0), 0.33, V.WhiteSmoke, g.ChaletLondon, P.Left)),
            (this.Description = t),
            (this._selectedSprite = new v('commonmenu', 'gradient_nav', new F(0, 0), new y(431, 38))),
            (this._badgeLeft = new v('commonmenu', '', new F(0, 0), new y(40, 40))),
            (this._badgeRight = new v('commonmenu', '', new F(0, 0), new y(40, 40))),
            (this._labelText = new K('', new F(0, 0), 0.35, V.White, 0, P.Right));
    }
    get Text() {
    ...
    SetVerticalPosition(e) {
        (this._rectangle.Pos = new F(this.Offset.X, e + 144 + this.Offset.Y)),
            (this._selectedSprite.Pos = new F(0 + this.Offset.X, e + 144 + this.Offset.Y)),
            (this._text.Pos = new F(8 + this.Offset.X, e + 147 + this.Offset.Y)),
            (this._badgeLeft.Pos = new F(0 + this.Offset.X, e + 142 + this.Offset.Y)),
            (this._badgeRight.Pos = new F(385 + this.Offset.X, e + 142 + this.Offset.Y)),
            (this._labelText.Pos = new F(420 + this.Offset.X, e + 148 + this.Offset.Y));
    }
    addEvent(e, ...t) {
        this._event = { event: e, args: t };
    }
    fireEvent() {
        this._event && n(this._event.event, ...this._event.args);
    }
    Draw() {
        (this._rectangle.Size = new y(431 + this.Parent.WidthOffset, 38)),
            (this._selectedSprite.Size = new y(431 + this.Parent.WidthOffset, 38)),
            this.Hovered &&
                !this.Selected &&
                ((this._rectangle.Color = new V(255, 255, 255, 20)), this._rectangle.Draw()),
            ...
            (this._text.Color = this.Enabled
                ...
                : new V(163, 159, 148)),
            this.LeftBadge != I.None
                ? ((this._text.Pos = new F(35 + this.Offset.X, this._text.Pos.Y)),
                ...
                : (this._text.Pos = new F(8 + this.Offset.X, this._text.Pos.Y)),
            this.RightBadge != I.None &&
                ((this._badgeRight.Pos = new F(385 + this.Offset.X + this.Parent.WidthOffset, this._badgeRight.Pos.Y)),
            ...
            this.RightLabel &&
                '' !== this.RightLabel &&
                ((this._labelText.Pos = new F(420 + this.Offset.X + this.Parent.WidthOffset, this._labelText.Pos.Y)),
    ...
    BadgeToColor(e, t) {
        switch (e) {
            ...
            case I.Tick:
            case I.Crown:
                return t ? new V(255, 0, 0, 0) : new V(255, 255, 255, 255);
            default:
                return new V(255, 255, 255, 255);
        }
    }
}
(z.DefaultBackColor = V.Empty),
    (z.DefaultHighlightedBackColor = V.White),
    (z.DefaultForeColor = V.WhiteSmoke),
    (z.DefaultHighlightedForeColor = V.Black);
class Z extends z {
    constructor(e, t = !1, i = '') {
        super(e, i), (this.Checked = !1);
        (this._checkedSprite = new v('commonmenu', 'shop_box_blank', new F(410, 95), new y(50, 50))),
            (this.Checked = t);
    }
    SetVerticalPosition(e) {
        super.SetVerticalPosition(e),
            (this._checkedSprite.Pos = new F(380 + this.Offset.X + this.Parent.WidthOffset, e + 138 + this.Offset.Y));
    }
    Draw() {
        super.Draw(),
            (this._checkedSprite.Pos = this._checkedSprite.Pos =
                new F(380 + this.Offset.X + this.Parent.WidthOffset, this._checkedSprite.Pos.Y));
        const e = this.HighlightedForeColor == z.DefaultHighlightedForeColor;
        this.Selected && e
    ...
    getListItems() {
        ...
        for (const t of this.items)
            t instanceof J
                ...
                : 'string' == typeof t
                ? e.push(new J(t))
                : 'number' == typeof t && e.push(new J(t.toString()));
        return e;
    }
}
class $ extends z {
    constructor(e, t = '', i = new j([]), s = 0, n = null) {
        super(e, t, n),
            ...
            (this._index = 0);
        (this.Collection = i.getListItems()),
            (this.Index = s),
            (this._arrowLeft = new v('commonmenu', 'arrowleft', new F(110, 105), new y(30, 30))),
            (this._arrowRight = new v('commonmenu', 'arrowright', new F(280, 105), new y(30, 30))),
            (this._itemText = new K('', new F(290, 104), 0.35, V.White, g.ChaletLondon, P.Right));
    }
    get Collection() {
    ...
    get Index() {
        return null == this.Collection || (null != this.Collection && 0 == this.Collection.length)
            ? -1
    ...
    set Index(e) {
        ...
        this._currentOffset = k.GetTextWidth(t, this._itemText && this._itemText.Font ? this._itemText.Font : 0, 0.35);
    }
    setCollection(e) {
    ...
    setCollectionItem(e, t, i = !0) {
        ...
        'string' == typeof t && (t = new J(t)), this.Collection.splice(e, 1, t), i && (this.Index = 0);
    }
    SetVerticalPosition(e) {
        (this._arrowLeft.Pos = new F(300 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)),
            (this._arrowRight.Pos = new F(400 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)),
            (this._itemText.Pos = new F(300 + this.Offset.X + this.Parent.WidthOffset, e + 147 + this.Offset.Y)),
            super.SetVerticalPosition(e);
    }
    SetRightLabel(e) {
        return this;
        ...
        (this._itemText.Color = this.Enabled
            ...
            (this._arrowRight.Color = this.Enabled
                ? this.Selected
                    ...
                    : this.ForeColor
                : new V(163, 159, 148)),
            (this._arrowLeft.Pos = new F(380 - t + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.Pos.Y)),
            this.Selected
                ? (this._arrowLeft.Draw(),
                  this._arrowRight.Draw(),
                  (this._itemText.Pos = new F(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y)))
                : (this._itemText.Pos = new F(420 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y)),
            this._itemText.Draw();
    }
}
Number.isInteger =
...
class q extends z {
    constructor(e, t = '', i = 0, s = 10, n = 0, h = null) {
        ...
        (this.LowerThreshold = i),
            (this.UpperThreshold = i > s ? i : s),
            (this.SelectedValue = n < i || n > s ? i : n),
            (this._arrowLeft = new v('commonmenu', 'arrowleft', new F(110, 105), new y(30, 30))),
            (this._arrowRight = new v('commonmenu', 'arrowright', new F(280, 105), new y(30, 30))),
            (this._itemText = new K('', new F(290, 104), 0.35, V.White, g.ChaletLondon, P.Right));
    }
    ...
    set PreCaptionText(e) {
        ...
        (this._preCaptionText = e),
            (this._currentOffset = k.GetTextWidth(
    ...
    set SelectedValue(e) {
        ...
        var t;
        (this._selectedValue = ((t = e), Number.isInteger(t) ? t : parseFloat(t.toFixed(10)))),
            (this._currentOffset = k.GetTextWidth(
                this.PreCaptionText + this._selectedValue.toString() + this.PostCaptionText,
                this._itemText && this._itemText.Font ? this._itemText.Font : 0,
        ...
        (this._itemText.Color = this.Enabled
            ...
            (this._arrowRight.Color = this.Enabled
                ? this.Selected
                    ...
                    : this.ForeColor
                : new V(163, 159, 148)),
            (this._arrowLeft.Pos = new F(380 - e + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.Pos.Y)),
            this.Selected
                ? (this._arrowLeft.Draw(),
                  this._arrowRight.Draw(),
                  (this._itemText.Pos = new F(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y)))
...
class Q extends z {
    constructor(e, t, i, s = '', n = !1, h = null) {
        super(e, s, h);
        (this._items = t),
            (this._arrowLeft = new v('commonmenutu', 'arrowleft', new F(0, 105), new y(15, 15))),
            (this._arrowRight = new v('commonmenutu', 'arrowright', new F(0, 105), new y(15, 15))),
            (this._rectangleBackground = new G(new F(0, 0), new y(150, 9), new V(4, 32, 57, 255))),
            (this._rectangleSlider = new G(new F(0, 0), new y(75, 9), new V(57, 116, 200, 255))),
            (this._rectangleDivider = new G(new F(0, 0), new y(2.5, 20), n ? V.WhiteSmoke : V.Transparent)),
            (this.Index = i);
    }
    get Index() {
    ...
    SetVerticalPosition(e) {
        (this._rectangleBackground.Pos = new F(
            250 + this.Offset.X + this.Parent.WidthOffset,
            e + 158.5 + this.Offset.Y,
        )),
            (this._rectangleSlider.Pos = new F(
                250 + this.Offset.X + this.Parent.WidthOffset,
                e + 158.5 + this.Offset.Y,
            )),
            (this._rectangleDivider.Pos = new F(
                323.5 + this.Offset.X + this.Parent.WidthOffset,
                e + 153 + this.Offset.Y,
            )),
            (this._arrowLeft.Pos = new F(235 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)),
            (this._arrowRight.Pos = new F(400 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)),
            super.SetVerticalPosition(e);
    }
    IndexToItem(e) {
    ...
    Draw() {
        super.Draw(),
            (this._arrowLeft.Color = this.Enabled ? (this.Selected ? V.Black : V.WhiteSmoke) : new V(163, 159, 148)),
            (this._arrowRight.Color = this.Enabled ? (this.Selected ? V.Black : V.WhiteSmoke) : new V(163, 159, 148));
        let e =
            ((this._rectangleBackground.Size.Width - this._rectangleSlider.Size.Width) / (this._items.length - 1)) *
            this.Index;
        (this._rectangleSlider.Pos = new F(
...
class ee extends B {
    ...
    Draw(e) {
        ...
        e = e || new y();
        const t = 1080 * (k.Width / k.Height),
            i = this.Size.Width / t,
            s = this.Size.Height / 1080,
            n = (this.Pos.X + e.Width) / t + 0.5 * i,
            h = (this.Pos.Y + e.Height) / 1080 + 0.5 * s;
        for (var o of (c.drawRect(n, h, i, s, this.Color.R, this.Color.G, this.Color.B, this.Color.A, !1), this.Items))
            o.Draw(new y(this.Pos.X + e.Width, this.Pos.Y + e.Height));
    }
}
class te {
    static PlaySound(e, t) {
        c.playSound(-1, e, t, !1, 0, !0);
    }
}
class ie {
    constructor() {
...
class se {
    constructor(e, t, i = null) {
        (this._itemBind = null),
            (this.Text = e),
            (this._buttonControl = t),
            (this._usingControls = null == i),
            (this._buttonString = i);
    }
    get ItemBind() {
    ...
    GetButtonId() {
        return this._usingControls
            ? c.getControlInstructionalButton(2, this._buttonControl, !1)
            : 't_' + this._buttonString;
    }
}
class ne {
    constructor(e) {
        (this._handle = 0), (this.scaleForm = e), (this._handle = O(this.scaleForm));
    }
    get handle() {
        return this._handle;
    }
        ...
        this.isValid &&
            ...
            t.forEach((e) => {
                switch (typeof e) {
                    ...
                    default:
                        h(
                            `Unknown argument type ${typeof e} = ${e.toString()} passed to scaleform with handle ${
                                this._handle
                            }`,
                        );
                }
    ...
    callFunction(e, ...t) {
        this.callFunctionHead(e, ...t), D();
    }
    callFunctionReturn(e, ...t) {
        return this.callFunctionHead(e, ...t), m();
    }
    render2D() {
        this.isValid && this.isLoaded && p(this._handle, 255, 255, 255, 255, 0);
    }
    recreate() {
        this.isValid && this.isLoaded && (S(this._handle), (this._handle = O(this.scaleForm)));
    }
    destroy() {
        this.isValid && (S(this._handle), (this._handle = 0));
    }
}
class he {
    static Initialize(e, t) {
        (this._transitionOutAnimName = t), (this._scaleform = new ne(e));
    }
    ...
    static Load() {
        null != this._delayedTransitionInTimeout &&
            (o(this._delayedTransitionInTimeout), (this._delayedTransitionInTimeout = null));
    }
    static SetDelayedTransition(e, t) {
        this._delayedTransitionInTimeout = r(() => {
            (this._delayedTransitionInTimeout = null), this.TransitionIn(e, t);
        }, this._transitionOutTimeMs);
    }
    static ShowCustomShard(e, t = 5e3, ...i) {
        this.ShowComplexCustomShard(() => {
            this._scaleform.callFunction(e, ...i);
        }, t);
    }
    ...
    static TransitionOut() {
        this._messageVisible &&
            (null != this._transitionOutTimeout && (o(this._transitionOutTimeout), (this._transitionOutTimeout = null)),
            null != this._transitionOutFinishedTimeout &&
                (o(this._transitionOutFinishedTimeout), (this._transitionOutFinishedTimeout = null)),
            this._scaleform.callFunction(this._transitionOutAnimName),
            (this._transitionOutFinishedTimeout = r(() => {
...
(he._messageVisible = !1),
    (he._transitionOutTimeout = null),
    (he._transitionOutFinishedTimeout = null),
    (he._delayedTransitionInTimeout = null),
    (he._scaleform = null),
    (he._transitionOutTimeMs = 500),
    (he._transitionOutAnimName = null);
class oe extends he {
    static Initialize(e, t) {
        super.Initialize(e, t), a(() => this.Render());
    }
    static ShowMissionPassedMessage(e, t = '', i = 5e3) {
        this.ShowCustomShard('SHOW_MISSION_PASSED_MESSAGE', i, e, t, 100, !0, 0, !0);
    }
    static ShowColoredShard(e, t, i, s, n = 5e3) {
        this.ShowCustomShard('SHOW_SHARD_CENTERED_MP_MESSAGE', n, e, t, s, i);
    }
    static ShowOldMessage(e, t = 5e3) {
        this.ShowCustomShard('SHOW_MISSION_PASSED_MESSAGE', t, e);
    }
    static ShowSimpleShard(e, t = '', i = 5e3) {
        this.ShowCustomShard('SHOW_SHARD_CREW_RANKUP_MP_MESSAGE', i, e, t);
    }
    static ShowRankupMessage(e, t, i, s = 5e3) {
        this.ShowCustomShard('SHOW_BIG_MP_MESSAGE', s, e, t, i, '', '');
    }
    static ShowPlaneMessage(e, t, i, s = 5e3) {
        this.ShowCustomShard('SHOW_PLANE_MESSAGE', s, e, t, i, '', '');
    }
    static ShowWeaponPurchasedMessage(e, t, i, s = 5e3) {
        this.ShowCustomShard('SHOW_WEAPON_PURCHASED', s, e, t, i, '', 100);
    }
    static ShowWastedMessage(e, t, i, s, n = 5e3) {
        this.ShowCustomShard('SHOW_SHARD_WASTED_MP_MESSAGE', n, e, t, i, s);
    }
    static ShowMpMessageLarge(e, t = '', i = 5e3) {
        this.ShowComplexCustomShard(() => {
            this.Scaleform.callFunction('SHOW_CENTERED_MP_MESSAGE_LARGE', e, t, 100, !0, 100),
                this.Scaleform.callFunction('TRANSITION_IN');
        }, i);
    }
}
oe.Initialize('MP_BIG_MESSAGE_FREEMODE', 'TRANSITION_OUT');
class re extends he {
    static Initialize(e, t) {
        super.Initialize(e, t), a(() => this.Render());
    }
    static ShowMidsizedMessage(e, t = '', i = 5e3) {
        this.ShowCustomShard('SHOW_MIDSIZED_MESSAGE', i, e, t);
    }
    static ShowBridgesKnivesProgress(e, t, i, s, n, h = 5e3) {
        this.ShowCustomShard('SHOW_BRIDGES_KNIVES_PROGRESS', h, e, t, i, s, n);
    }
    static ShowCondensedShardMessage(e, t, i, s, n = 5e3) {
        this.ShowCustomShard('SHOW_COND_SHARD_MESSAGE', n, e, t, i, s);
    }
    static ShowMidsizedShardMessage(e, t, i, s, n, h = 5e3) {
        this.ShowCustomShard('SHOW_SHARD_MIDSIZED_MESSAGE', h, e, t, i, s, n);
    }
}
re.Initialize('MIDSIZED_MESSAGE', 'SHARD_ANIM_OUT');
class ae extends z {
    constructor(e, t, i = '', s = null, n = null) {
        super(e, i, n),
            ...
            (this._selectedStartValueHandler = s);
        (this._arrowLeft = new v('commonmenu', 'arrowleft', new F(110, 105), new y(30, 30))),
            (this._arrowRight = new v('commonmenu', 'arrowright', new F(280, 105), new y(30, 30))),
            (this._itemText = new K('', new F(290, 104), 0.35, V.White, g.ChaletLondon, P.Right));
    }
    SelectionChangeHandlerPromise(e, t, i) {
        return new Promise((s, n) => {
            s(this.SelectionChangeHandler(e, t, i));
        });
    }
    get PreCaptionText() {
        return this._precaptionText;
...
class _e {
    constructor(e, t, i, s, n) {
        (this._visible = !0),
            ...
            (this._safezoneOffset = new F(0, 0)),
            ...
            (this.Id = X()),
            (this.SelectTextLocalized = l('HUD_INPUT2')),
            (this.BackTextLocalized = l('HUD_INPUT3')),
            (this.WidthOffset = 0),
            ...
            (this.MenuItems = []),
            (this.IndexChange = new ie()),
            (this.ListChange = new ie()),
            (this.AutoListChange = new ie()),
            (this.DynamicListChange = new ie()),
            (this.SliderChange = new ie()),
            (this.CheckboxChange = new ie()),
            (this.ItemSelect = new ie()),
            (this.MenuOpen = new ie()),
            (this.MenuClose = new ie()),
            (this.MenuChange = new ie()),
            i instanceof F || (i = F.Parse(i)),
            (this._spriteLibrary = s || 'commonmenu'),
            (this._spriteName = n || 'interaction_bgd'),
            (this._offset = new F(i.X, i.Y)),
            (this.Children = new Map()),
            (this._instructionalButtonsScaleform = new ne('instructional_buttons')),
            this.UpdateScaleform(),
            (this._mainMenu = new ee(new F(0, 0), new y(700, 500), new V(0, 0, 0, 0))),
            (this._bannerSprite = new v(
                this._spriteLibrary,
                this._spriteName,
                new F(0 + this._offset.X, 0 + this._offset.Y),
                new y(431, 107),
            )),
            this._mainMenu.addItem(
                (this._titleResText = new K(
                    e,
                    new F(215 + this._offset.X, 20 + this._offset.Y),
            ...
            '' !== t &&
                (this._mainMenu.addItem(
                    new G(new F(0 + this._offset.X, 107 + this._offset.Y), new y(431, 37), new V(0, 0, 0, 255)),
                ),
                this._mainMenu.addItem(
                    (this._subtitleResText = new K(
                        t,
                        new F(8 + this._offset.X, 110 + this._offset.Y),
                        0.35,
                        new V(255, 255, 255),
                        0,
                        P.Left,
                ...
                t.startsWith('~') && (this._counterPretext = t.substr(0, 3)),
                (this._counterText = new K(
                    '',
                    new F(425 + this._offset.X, 110 + this._offset.Y),
                    0.35,
                    new V(255, 255, 255),
                    0,
                    P.Right,
            ...
            (this._extraRectangleUp = new G(
                new F(
                    0 + this._offset.X,
                    144 + 38 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset,
                ),
                new y(431, 18),
                new V(0, 0, 0, 200),
            )),
            (this._extraRectangleDown = new G(
                new F(
                    0 + this._offset.X,
                    162 + 38 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset,
                ),
                new y(431, 18),
                new V(0, 0, 0, 200),
            )),
            (this._descriptionBar = new G(new F(this._offset.X, 123), new y(431, 4), V.Black)),
            (this._descriptionRectangle = new v(
                'commonmenu',
                'gradient_bgd',
                new F(this._offset.X, 127),
                new y(431, 30),
            )),
            (this._descriptionText = new K(
                '',
                new F(this._offset.X + 5, 125),
                0.35,
                new V(255, 255, 255, 255),
                g.ChaletLondon,
                P.Left,
            )),
            (this._descriptionText.Wrap = 400),
            (this._background = new v(
                'commonmenu',
                'gradient_bgd',
                new F(this._offset.X, 144 + this._offset.Y - 37 + this._extraOffset),
                new y(290, 25),
            )),
            (this._visible = !1),
            a(this.render.bind(this));
    }
    GetSpriteBanner() {
    ...
    set Visible(e) {
        if (
            ((this._visible = e),
            te.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
            this.UpdateScaleform(),
            ...
            if (e) {
                if (
                    ((this._justOpened = !0),
                    this.MenuOpen.emit(),
                    null === this.ParentMenu && !le.includes(this) && this !== this._poolOpening)
                ) {
                    const e = le.length ? le[le.length - 1] : null;
                    le.push(this),
                        e !== this._poolOpening && null !== e && ((e._justClosedFromPool = !0), (e.Visible = !1));
                }
            } else {
                ...
                null === this.ParentMenu &&
                    ...
                    le.length &&
                    (le[le.length - 1] === this &&
                        (le.pop(), (this._justOpenedFromPool = !0), le.length || (this._poolOpening = null)),
                    le.length && ((this._poolOpening = le[le.length - 1]), (le[le.length - 1].Visible = !0))),
                    0 === le.length && c.setMouseCursorSprite(1);
            }
    ...
    set CurrentSelection(e) {
        (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1),
            (this._activeItem = this._maxMenuItems - (this._maxMenuItems % this.MenuItems.length) + e),
    ...
    SetRectangleBannerType(e) {
        (this._bannerSprite = null),
            ...
            (this._bannerRectangle.Pos = new F(this._offset.X, this._offset.Y)),
            (this._bannerRectangle.Size = new y(431 + this.WidthOffset, 107));
    }
    AddSpriteBannerType(e) {
        (this._bannerSprite = e),
            (this._bannerSprite.Size = new y(431 + this.WidthOffset, 107)),
            (this._bannerSprite.Pos = new F(this._offset.X, this._offset.Y));
    }
    SetNoBannerType() {
        (this._bannerSprite = null),
            (this._bannerRectangle = new G(
                new F(this._offset.X, this._offset.Y),
                new y(431 + this.WidthOffset, 107),
                new V(0, 0, 0, 0),
            ));
    }
    RemoveInstructionalButton(e) {
        for (let t = 0; t < this._instructionalButtons.length; t++)
            this._instructionalButtons[t] === e && this._instructionalButtons.splice(t, 1);
    }
    RecalculateDescriptionPosition() {
        const e =
            this.MenuItems.length > this._maxItemsOnScreen + 1 ? this._maxItemsOnScreen + 2 : this.MenuItems.length;
        (this._descriptionBar.Size = new y(431 + this.WidthOffset, 4)),
            (this._descriptionRectangle.Size = new y(431 + this.WidthOffset, 30)),
            (this._descriptionBar.Pos = new F(this._offset.X, 112 + this._extraOffset + this._offset.Y)),
            (this._descriptionRectangle.Pos = new F(this._offset.X, 112 + this._extraOffset + this._offset.Y)),
            (this._descriptionText.Pos = new F(this._offset.X + 8, 118 + this._extraOffset + this._offset.Y)),
            (this._descriptionBar.Pos = new F(this._offset.X, 38 * e + this._descriptionBar.Pos.Y)),
            (this._descriptionRectangle.Pos = new F(this._offset.X, 38 * e + this._descriptionRectangle.Pos.Y)),
            (this._descriptionText.Pos = new F(this._offset.X + 8, 38 * e + this._descriptionText.Pos.Y));
    }
    SetMenuWidthOffset(e) {
        if (
            ((this.WidthOffset = e),
            null != this._bannerSprite && (this._bannerSprite.Size = new y(431 + this.WidthOffset, 107)),
            (this._mainMenu.Items[0].pos = new F((this.WidthOffset + this._offset.X + 431) / 2, 20 + this._offset.Y)),
            this._counterText && (this._counterText.Pos = new F(425 + this._offset.X + e, 110 + this._offset.Y)),
            this._mainMenu.Items.length >= 2)
        ) {
            this._mainMenu.Items[1].size = new y(431 + this.WidthOffset, 37);
        }
        null != this._bannerRectangle && (this._bannerRectangle.Size = new y(431 + this.WidthOffset, 107));
    }
    AddItem(e) {
        this._justOpened && (this._justOpened = !1),
            (e.Offset = this._offset),
            (e.Parent = this),
            e.SetVerticalPosition(25 * this.MenuItems.length - 37 + this._extraOffset),
    ...
    CleanUp(e = !1) {
        e &&
            ...
            this.MenuItems.filter((e) => e instanceof ae).forEach((e) => {
    ...
    GoLeft() {
        if (
            (this.MenuItems[this.CurrentSelection] instanceof $ ||
                this.MenuItems[this.CurrentSelection] instanceof q ||
                this.MenuItems[this.CurrentSelection] instanceof ae ||
                this.MenuItems[this.CurrentSelection] instanceof Q) &&
            this.MenuItems[this.CurrentSelection].Enabled
        )
            if (this.MenuItems[this.CurrentSelection] instanceof $) {
                const e = this.MenuItems[this.CurrentSelection];
                if (0 == e.Collection.length) return;
                e.Index--,
                    te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.ListChange.emit(e, e.Index),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof q) {
                const e = this.MenuItems[this.CurrentSelection];
                e.SelectedValue <= e.LowerThreshold
                    ? (e.SelectedValue = e.UpperThreshold)
                    : (e.SelectedValue -= e.LeftMoveThreshold),
                    te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.AutoListChange.emit(e, e.SelectedValue, N.Left),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof ae) {
                const e = this.MenuItems[this.CurrentSelection];
                e.SelectionChangeHandlerPromise(e, e.SelectedValue, N.Left).then((t) => {
                    (e.SelectedValue = t), this.DynamicListChange.emit(e, e.SelectedValue, N.Left);
                }),
                    te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof Q) {
        ...
        if (
            ...
            if (this.MenuItems[this.CurrentSelection] instanceof $) {
                ...
                e.SelectedValue >= e.UpperThreshold
                    ...
                    te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.AutoListChange.emit(e, e.SelectedValue, N.Right),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof ae) {
                const e = this.MenuItems[this.CurrentSelection];
                e.SelectionChangeHandlerPromise(e, e.SelectedValue, N.Right).then((t) => {
                    (e.SelectedValue = t), this.DynamicListChange.emit(e, e.SelectedValue, N.Right);
                }),
                    te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof Q) {
    ...
    SelectItem() {
        if (!this.MenuItems[this.CurrentSelection].Enabled)
            return void te.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY);
        const e = this.MenuItems[this.CurrentSelection];
        if (this.MenuItems[this.CurrentSelection] instanceof Z)
            (e.Checked = !e.Checked),
                te.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
    ...
    HasCurrentSelectionChildren() {
        const e = this.MenuItems[this.CurrentSelection];
        return !!(this.MenuItems[this.CurrentSelection] instanceof z && this.Children.has(e.Id));
    }
    IsMouseInListItemArrows(e, t, i) {
        c.beginTextCommandGetWidth('jamyfafi'), c.addTextComponentSubstringPlayerName(e.Text);
        let s = k.ResolutionMaintainRatio;
        let n = 1080 * (s.Width / s.Height);
        const h = 5 + c.endTextCommandGetWidth(!1) * n * 0.35 + 10,
            o = 431 - h;
        return k.IsMouseInBounds(t, new y(h, 38)) ? 1 : k.IsMouseInBounds(new F(t.X + h, t.Y), new y(o, 38)) ? 2 : 0;
    }
    ProcessMouse() {
        if (!this.Visible || this._justOpened || 0 == this.MenuItems.length || !this.MouseControlsEnabled)
            return void this.MenuItems.filter((e) => e.Hovered).forEach((e) => (e.Hovered = !1));
        _(!0);
        let e = this.MenuItems.length - 1,
            t = 0;
        this.MenuItems.length > this._maxItemsOnScreen + 1 && (e = this._maxItem),
            k.IsMouseInBounds(new F(0, 0), new y(30, 1080)) && this._mouseEdgeEnabled
                ? (c.setGameplayCamRelativeHeading(c.getGameplayCamRelativeHeading() + 5), c.setMouseCursorSprite(6))
                : k.IsMouseInBounds(new F(k.ResolutionMaintainRatio.Width - 30, 0), new y(30, 1080)) &&
                  this._mouseEdgeEnabled
                ? (c.setGameplayCamRelativeHeading(c.getGameplayCamRelativeHeading() - 5), c.setMouseCursorSprite(7))
                : this._mouseEdgeEnabled && c.setMouseCursorSprite(1);
        for (let i = this._minItem; i <= e; i++) {
            let e = this._offset.X,
                s = this._offset.Y + 144 - 37 + this._extraOffset + 38 * t,
                n = 431 + this.WidthOffset;
            const h = 38,
                o = this.MenuItems[i];
            if (k.IsMouseInBounds(new F(e, s), new y(n, h))) {
                o.Hovered = !0;
                const t = this.IsMouseInListItemArrows(this.MenuItems[i], new F(e, s), 0);
                if (
                    (o.Hovered &&
                        1 == t &&
                        (this.MenuItems[i] instanceof $ ||
                            this.MenuItems[i] instanceof q ||
                            this.MenuItems[i] instanceof ae) &&
                        c.setMouseCursorSprite(5),
                    c.isControlJustReleased(0, 24) || c.isDisabledControlJustReleased(0, 24))
                )
                    if (o.Selected && o.Enabled)
                        if (
                            (this.MenuItems[i] instanceof $ ||
                                this.MenuItems[i] instanceof q ||
                                this.MenuItems[i] instanceof ae) &&
                            this.IsMouseInListItemArrows(this.MenuItems[i], new F(e, s), 0) > 0
                        )
                            switch (t) {
                                case 1:
                                    te.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
                                    ...
                                    break;
                                case 2:
                                    let e = this.MenuItems[i];
                                    (null == e.Collection ? e.Items.Count : e.Collection.Count) > 0 &&
                                        (e.Index++,
                                        te.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                                        this.ListChange.emit(e, e.Index));
                            }
                        ...
                        o.Selected
                            ? !o.Enabled && o.Selected && te.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY)
                            : ((this.CurrentSelection = i),
                              te.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY),
        ...
        const i =
            ...
            s = this._safezoneOffset.X + this._offset.X;
        this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
            (k.IsMouseInBounds(new F(s, i), new y(431 + this.WidthOffset, 18))
                ? ((this._extraRectangleUp.Color = new V(30, 30, 30, 255)),
                  (c.isControlJustPressed(0, 24) || c.isDisabledControlJustPressed(0, 24)) &&
                      (this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoUpOverflow() : this.GoUp()))
                : (this._extraRectangleUp.Color = new V(0, 0, 0, 200)),
            k.IsMouseInBounds(new F(s, i + 18), new y(431 + this.WidthOffset, 18))
                ? ((this._extraRectangleDown.Color = new V(30, 30, 30, 255)),
                  (c.isControlJustPressed(0, 24) || c.isDisabledControlJustPressed(0, 24)) &&
                      (this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoDownOverflow() : this.GoDown()))
                : (this._extraRectangleDown.Color = new V(0, 0, 0, 200)));
    }
    ProcessControl() {
        this.Visible &&
            (this._justOpened
                ? (this._justOpened = !1)
                : (c.isControlJustReleased(0, 177) && this.GoBack(),
                  0 != this.MenuItems.length &&
                      (c.isControlPressed(0, 172) && this._lastUpDownNavigation + 120 < Date.now()
                          ? ((this._lastUpDownNavigation = Date.now()),
                            this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoUpOverflow() : this.GoUp(),
                            this.UpdateScaleform())
                          : c.isControlJustReleased(0, 172)
                          ? (this._lastUpDownNavigation = 0)
                          : c.isControlPressed(0, 173) && this._lastUpDownNavigation + 120 < Date.now()
                          ? ((this._lastUpDownNavigation = Date.now()),
                            this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoDownOverflow() : this.GoDown(),
                            this.UpdateScaleform())
                          : c.isControlJustReleased(0, 173)
                          ? (this._lastUpDownNavigation = 0)
                          : c.isControlPressed(0, 174) && this._lastLeftRightNavigation + 100 < Date.now()
                          ? ((this._lastLeftRightNavigation = Date.now()), this.GoLeft())
                          : c.isControlJustReleased(0, 174)
                          ? (this._lastLeftRightNavigation = 0)
                          : c.isControlPressed(0, 175) && this._lastLeftRightNavigation + 100 < Date.now()
                          ? ((this._lastLeftRightNavigation = Date.now()), this.GoRight())
                          : c.isControlJustReleased(0, 175)
                          ? (this._lastLeftRightNavigation = 0)
                          : c.isControlJustReleased(0, 201) && this.SelectItem())));
    }
    GoUpOverflow() {
        this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
    ...
    GoBack() {
        null != this.ParentMenu
            ...
            : this.CloseableByUser && ((this.Visible = !1), this.CleanUp(!0), this.MenuClose.emit(!1));
    }
    BindMenuToItem(e, t) {
    ...
    CalculateDescription() {
        if (
            ...
            (this._recalculateDescriptionNextFrame > 0 && this._recalculateDescriptionNextFrame--,
            ...
            (this._descriptionRectangle.Size = new y(431 + this.WidthOffset, 25 * e + 15)),
    ...
    UpdateScaleform() {
        ...
        this._instructionalButtonsScaleform.callFunction('CLEAR_ALL'),
            ...
            this._instructionalButtonsScaleform.callFunction(
                'SET_DATA_SLOT',
                0,
                c.getControlInstructionalButton(2, H.PhoneSelect, !1),
                this.SelectTextLocalized,
            ),
            this._instructionalButtonsScaleform.callFunction(
                'SET_DATA_SLOT',
                1,
                c.getControlInstructionalButton(2, H.PhoneCancel, !1),
    ...
    render() {
        ...
        this._buttonsEnabled &&
            (c.drawScaleformMovieFullscreen(this._instructionalButtonsScaleform.handle, 255, 255, 255, 255, 0),
            c.hideHudComponentThisFrame(6),
            c.hideHudComponentThisFrame(7),
            c.hideHudComponentThisFrame(9)),
            this._justOpened &&
                ...
                this._recalculateDescriptionNextFrame || this._recalculateDescriptionNextFrame++),
            this._mainMenu.Draw(),
            this.ProcessMouse(),
            this.ProcessControl(),
            (this._background.Size =
                this.MenuItems.length > this._maxItemsOnScreen + 1
                    ? new y(431 + this.WidthOffset, 38 * (this._maxItemsOnScreen + 1))
                    : new y(431 + this.WidthOffset, 38 * this.MenuItems.length)),
            this._background.Draw(),
            this._recalculateDescriptionNextFrame && this.CalculateDescription(),
            this.MenuItems.length > 0 &&
                ((this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0),
                '' !== this.MenuItems[this._activeItem % this.MenuItems.length].Description.trim() &&
                    (this._descriptionBar.Draw(), this._descriptionRectangle.Draw(), this._descriptionText.Draw()));
        let e = 0;
        if (this.MenuItems.length <= this._maxItemsOnScreen + 1) {
            ...
            this._counterText &&
                ...
                ((this._counterText.Caption = this._counterPretext + this._counterOverride), this._counterText.Draw());
        } else {
            for (let t = this._minItem; t <= this._maxItem; t++) {
                let i = this.MenuItems[t];
                i.SetVerticalPosition(38 * e - 37 + this._extraOffset), i.Draw(), e++;
            }
            if (
                ((this._extraRectangleUp.Size = new y(431 + this.WidthOffset, 18)),
                (this._extraRectangleDown.Size = new y(431 + this.WidthOffset, 18)),
                (this._upAndDownSprite.Pos = new F(
...
export {
    ...
    I as BadgeStyle,
    oe as BigMessage,
    N as ChangeDirection,
    V as Color,
    H as Control,
    g as Font,
    x as HudColor,
    se as InstructionalButton,
    j as ItemsCollection,
    J as ListItem,
    _e as Menu,
    re as MidsizedMessage,
    F as Point,
    G as ResRectangle,
    y as Size,
    v as Sprite,
    q as UIMenuAutoListItem,
    Z as UIMenuCheckboxItem,
    ae as UIMenuDynamicListItem,
    z as UIMenuItem,
    $ as UIMenuListItem,
    Q as UIMenuSliderItem,
};
